...
static PyObject* teethris_setLightingForKeyWithKeyName(PyObject* self, PyObject* args)
{
	int key;
	int red, green, blue;
...
static PyMethodDef TeethrisMethods[] = {
	{"setLightingForKeyWithKeyName", teethris_setLightingForKeyWithKeyName, METH_VARARGS,
...
void registerConstantKeyNames(PyObject* module)
{
	...
	PyModule_AddObject(module, "BACKSLASH", Py_BuildValue("i", LogiLed::KeyName::BACKSLASH));
...
int main(int argc, char* argv[])
{
	...
	if (pModule != nullptr)
	{
		pFunc = PyObject_GetAttrString(pModule, "game_start");
