...
keyboard = {teethris.ESC:(), teethris.F1:(teethris.ONE,teethris.TWO,teethris.F2),teethris.F2:(teethris.F1,teethris.F3,teethris.TWO,teethris.THREE),teethris.F3:(teethris.F2,teethris.F4,teethris.THREE,teethris.FOUR),teethris.F4:(teethris.F3,teethris.F5,teethris.FOUR,teethris.FIVE),teethris.F5:(teethris.F6,teethris.F4,teethris.SIX,teethris.SEVEN),teethris.F6:(teethris.F7,teethris.F5,teethris.SEVEN,teethris.EIGHT),teethris.F7:(teethris.F6,teethris.F8,teethris.EIGHT,teethris.NINE),teethris.F8:(teethris.F7,teethris.F9,teethris.NINE,teethris.ZERO),teethris.F9:(teethris.F10,teethris.F8,teethris.MINUS),teethris.F10:(teethris.F9,teethris.F11,teethris.EQUALS),teethris.F11:(teethris.F10,teethris.F12,teethris.BACKSPACE),teethris.F12:(teethris.F11,teethris.PRINT_SCREEN,teethris.BACKSPACE),teethris.PRINT_SCREEN:(teethris.F12,teethris.SCROLL_LOCK,teethris.INSERT),teethris.SCROLL_LOCK:(teethris.PRINT_SCREEN,teethris.PAUSE_BREAK,teethris.HOME),
            ...
            teethris.LEFT_SHIFT:(teethris.CAPS_LOCK,teethris.LEFT_CONTROL,teethris.LEFT_BACKSLASH),teethris.LEFT_BACKSLASH:(teethris.LEFT_SHIFT,teethris.LEFT_CONTROL,teethris.A,teethris.Z),teethris.Z:(teethris.LEFT_BACKSLASH,teethris.A,teethris.S,teethris.X,teethris.LEFT_ALT),teethris.X:(teethris.Z,teethris.S,teethris.D,teethris.C,teethris.LEFT_ALT,teethris.SPACE),teethris.C:(teethris.X,teethris.D,teethris.F,teethris.V,teethris.SPACE),teethris.V:(teethris.C,teethris.F,teethris.G,teethris.SPACE,teethris.B),teethris.B:(teethris.V,teethris.G,teethris.H,teethris.SPACE,teethris.N),teethris.N:(teethris.B,teethris.H,teethris.J,teethris.M,teethris.SPACE),teethris.M:(teethris.N,teethris.J,teethris.K,teethris.SPACE,teethris.COMMA),teethris.COMMA:(teethris.M,teethris.K,teethris.L,teethris.SPACE,teethris.PERIOD,teethris.RIGHT_ALT),teethris.PERIOD:(teethris.COMMA,teethris.L,teethris.SEMICOLON,teethris.FORWARD_SLASH,teethris.RIGHT_ALT),teethris.FORWARD_SLASH:(teethris.PERIOD,teethris.SEMICOLON,teethris.APOSTROPHE,teethris.RIGHT_SHIFT),teethris.RIGHT_SHIFT:(teethris.APPLICATION_SELECT,teethris.FORWARD_SLASH,teethris.APOSTROPHE,teethris.RIGHT_BACKSLASH,teethris.RIGHT_CONTROL,teethris.ARROW_UP),teethris.ARROW_UP:(teethris.RIGHT_SHIFT,teethris.ENTER,teethris.KEYBOARD_DELETE,teethris.END,teethris.PAGE_DOWN,teethris.NUM_FOUR,teethris.NUM_ONE,teethris.ARROW_DOWN),teethris.NUM_ONE:(teethris.ARROW_UP,teethris.NUM_FOUR,teethris.NUM_TWO,teethris.NUM_ZERO),teethris.NUM_TWO:(teethris.NUM_ONE,teethris.NUM_THREE,teethris.NUM_ZERO,teethris.NUM_FIVE),teethris.NUM_THREE:(teethris.NUM_TWO,teethris.NUM_SIX,teethris.NUM_PERIOD),
            teethris.LEFT_CONTROL:(teethris.LEFT_SHIFT,teethris.LEFT_BACKSLASH),teethris.LEFT_ALT:(teethris.Z,teethris.X,teethris.SPACE),teethris.SPACE:(teethris.LEFT_ALT,teethris.X,teethris.C,teethris.V,teethris.B,teethris.N,teethris.M,teethris.COMMA,teethris.RIGHT_ALT),teethris.RIGHT_ALT:(teethris.SPACE,teethris.COMMA,teethris.PERIOD),teethris.APPLICATION_SELECT:(teethris.RIGHT_SHIFT,teethris.RIGHT_CONTROL),teethris.RIGHT_CONTROL:(teethris.APPLICATION_SELECT,teethris.RIGHT_SHIFT,teethris.ARROW_LEFT),teethris.ARROW_LEFT:(teethris.APPLICATION_SELECT,teethris.ARROW_DOWN,teethris.RIGHT_CONTROL),teethris.ARROW_DOWN:(teethris.ARROW_LEFT,teethris.ARROW_UP,teethris.ARROW_RIGHT),teethris.ARROW_RIGHT:(teethris.ARROW_DOWN,teethris.NUM_ZERO),teethris.NUM_ZERO:(teethris.NUM_PERIOD,teethris.NUM_ONE,teethris.NUM_TWO)}
...
class Snake:
    ...
    def __init__(self, key, friend):
        ...
        print("Echt printen")
        self.friend = friend
        teethris.setLighting(key, 0, 100-self.friend*100, self.friend*100)
