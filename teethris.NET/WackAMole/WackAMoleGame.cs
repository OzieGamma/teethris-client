// <copyright company="Oswald MASKENS, Boris GORDTS, Tom EELBODE, Zoë PETARD" file="WackAMoleGame.cs">
...
namespace teethris.NET.WackAMole
{
    public class WackAMoleGame : IGame
    {
